...
<?php echo $this->Form->create('BatchesClaim');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Batches Claim'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BatchesClaim.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BatchesClaim.id'))); ?></li>
