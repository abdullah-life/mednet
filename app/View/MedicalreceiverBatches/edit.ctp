...
<?php echo $this->Form->create('MedicalreceiverBatch');?>
	<fieldset>
		<legend><?php echo __('Edit Medicalreceiver Batch'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MedicalreceiverBatch.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MedicalreceiverBatch.id'))); ?></li>
