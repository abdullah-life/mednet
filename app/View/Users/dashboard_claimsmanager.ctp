            ...
            <tr>
                <td width="25%">
                    <div class="post-block">
                        ...
                        <ul class="linkdash">
                            <?php echo $this->Html->link(__('List Batches'), array('controller' => 'batches', 'action' => 'list_allbatches_for_claimsmanager')); ?>
                        </ul>   
                    </div>
                </td>
            ...
            <tr>
                ...
                <td width="25%"> 
                    <div class="post-block">
                        ...
                        <ul class="linkdash">
                            <?php echo $this->Html->link(__('List Resubmission Batches'), array('controller' => 'Batches', 'action' => 'resubmissionbatches')); ?>
                        </ul>   
                    </div>
                </td>
            </tr>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link('Upload XML',array('controller' => "Xmllistings",'action' => "xmlthroughemails")) ?></li>
	</ul>
