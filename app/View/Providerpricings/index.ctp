...
<div class="notification">
    ...
    ?>
        ...
        .notification
        {
            ...
            min-height:20px;
            font-size:17px;
            background: url('<?php echo Router::url('/',true)?>/app/webroot/img/message_unread.png');
        ...
        <?php 
          ...
          <style>      
            .notification
            {
                ...
                min-height:20px;
                font-size:17px;
                background: url('<?php echo Router::url('/',true)?>/app/webroot/img/message.png');
                background-repeat:no-repeat;
                background-position:left;
                z-index: 999999999999;
            }
    ...
    <div id="search" style="width:100%;height:auto;float:left;border: 1px solid #CDCDCD !important;">
        ...
        <table style="width:700px;" >
            ...
            <tr>
                ...
                <td width="30%">
                    <?php
                        ...
                        echo $this->Form->input('dates',array('type'=>'select','options' => $datedata,'selected'=>$this->Session->read('dateforsearch'),'empty'=>'Select the date','class' => 'date'));
            ...
            <tr>
                <td> 
                    <?php
                        if(isset($providerpricings[0]['Providerpricing']))
                            echo $this->Html->link($this->Html->image('export.png',array('title'=>'download')), array('controller'=>'providerpricings','action' => 'createtxt'),array('escape'=>FALSE)); ?>
                </td>
            </tr>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Upload privderpricings'), array('action' => 'add')); ?></li>
		<li><?php echo $this->Html->link(__('Add Provider pricing'), array('action' => 'singleadd')); ?></li>
		...
		<li><?php echo $this->Html->link(__('List common HAAD pricing'), array('controller'=>'Haadpricings','action' => 'index')); ?></li>
                ...
                <li><?php echo $this->Html->link(__('Active Dubai providers'), array('controller'=>'Providerdetails','action' => 'listactivedubaiproviders')); ?></li>
	</ul>
</div>
<style>
    .not_linked{
...
<script type="text/javascript">
    $(document).ready(function(){
         $( ".notification" ).click(function(){
             window.location.href = "<?php echo Router::url('/',true)?>Missingproviders/details"
        });
    });
</script>