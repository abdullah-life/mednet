...
<?php echo $this->Form->create('Providerpricing' ,array('type' => 'file'));?>
	<fieldset>
		<legend><?php echo __('Add Providerpricing'); ?></legend>
	<?php
		echo $this->Form->input('providerdetail_id',array('class' => 'providerids'));
		echo $this->Form->input('start_date', array('type' => 'date'));
		echo "<span style='color:red'> Upload .xls files only</span>";
